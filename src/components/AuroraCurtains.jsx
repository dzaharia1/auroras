...
import { getPositionFromLatLon } from '../utils/geoReference';
...
function populateMesh(mesh, coords, earthRadius) {
  ...
  for (let i = 0; i < count; i++) {
    ...
    // Convert directly from geographic coordinates using shared reference
    const pos = getPositionFromLatLon(lat, lon, earthRadius);
